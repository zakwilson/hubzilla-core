...
{{/if}}
	...
	<ul class="nav nav-pills flex-column">
		...
		<li class="nav-item nav-item-hack" id="{{$page.link_id}}">
			...
			<i class="nav-link widget-nav-pills-icons fa fa-trash-o drop-icons" onclick="wiki_delete_page('{{$page.title|escape:'quotes'}}', '{{$page.title|escape:'url'}}', '{{$page.resource_id}}', '{{$page.link_id}}')"></i>
			{{/if}}
