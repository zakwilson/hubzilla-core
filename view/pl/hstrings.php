...
App::$strings["Make this hub my primary location"] = "Ustaw ten serwis jako moją główną lokalizację";
...
App::$strings["%1\$s doesn't like %2\$s's %3\$s"] = "%1\$s dezaprobował %3\$s  %2\$s";
...
App::$strings["The unmoderated public stream of this hub"] = "Niemoderowany strumień publiczny tego serwisu";
...
App::$strings["Unable to find your hub."] = "Nie można znaleźć Twojego serwisu.";
...
App::$strings["Wall posts"] = "Tablica wpisów";
...
App::$strings["When possible, drop a location by logging into that website/hub and removing your channel."] = "Jeśli to możliwe, upuść lokalizację, logując się do tego serwisu i usuwając swój kanał.";
App::$strings["Use this form to drop the location if the hub is no longer operating."] = "Użyj tego formularza, aby usunąć lokalizację, jeśli serwis już nie działa.";
...
App::$strings["Verify successfull"] = "Weryfikacja powiodła się";
...
App::$strings["Resend"] = "Wyślij ponownie";
...
App::$strings["Public Hubs"] = "Węzły publiczne";
...
App::$strings["Hub URL"] = "Adres URL serwisu";
...
App::$strings["Export your basic channel information to a file.  This acts as a backup of your connections, permissions, profile and basic data, which can be used to import your data to a new server hub, but does not contain your content."] = "Wyeksportuj do pliku podstawowe informacje o kanale. Działa to jako kopia zapasowa połączeń, uprawnień, profilu i podstawowych danych, których można użyć do zaimportowania danych do nowego serwisu, ale nie zawiera treści.";
...
App::$strings["__ctx:noun__ Dislikes"] = "Niepolubienia";
...
App::$strings["Mark hub permanently offline"] = "Oznacz serwis na stałe w trybie offline";
App::$strings["Empty queue for this hub"] = "Pusta kolejka dla tego serwisu";
...
App::$strings["My site is not a public server"] = "Mój serwis nie jest serwerem publicznym";
...
App::$strings["Hour(s)"] = "Godzin/Godziny";
...
App::$strings["Which best describes the types of account offered by this hub?"] = "Które z poniższych stwierdzeń najlepiej opisuje rodzaje kont oferowanych przez ten serwis?";
...
App::$strings["No suggestions available. If this is a new site, please try again in 24 hours."] = "Brak dostępnych propozycji. Jeśli to jest nowy serwis, spróbuj ponownie za 24 godziny.";
...
App::$strings["Terms of Service not accepted"] = "Regulamin serwisu nie został zaakceptowany";
...
App::$strings["Email address already in use"] = "Ten adres e-mail jest już używany";
App::$strings["Registration on this hub is by invitation only"] = "Rejestracja w tym serwisie odbywa się wyłącznie za zaproszeniem";
...
App::$strings["Register at another affiliated hub in case when prefered"] = "Zarejestruj się w innym stowarzyszonym serwisie w przypadku, gdy potrzebujesz takiego rozwiązania";
App::$strings["Registration on this hub is by invitation only."] = "Rejestracja na tym węźle wymaga uprzedniego zaproszenia.";
App::$strings["Register at another affiliated hub"] = "Zarejestruj się w innym stowarzyszonym serwisie";
...
App::$strings["Why do you want to join this hub?"] = "Dlaczego chcesz dołączyć do tego serwisu?";
...
App::$strings["This site has exceeded the number of allowed daily account registrations."] = "Na tym serwisie przekroczono  dozwoloną liczbę dziennych rejestracji kont.";
...
App::$strings["Someone writes on your profile wall"] = "Ktoś pisze na Twojej tablicy profilu";
...
App::$strings["If your channel is mirrored to multiple hubs, set this to your preferred location. This will prevent duplicate email notifications. Example: %s"] = "Jeśli twój kanał jest powielany na wielu serwisach, ustaw to na preferowaną lokalizację. Zapobiegnie to powielaniu powiadomień e-mail. Przykład: % s";
App::$strings["Show new wall posts, private messages and connections under Notices"] = "Pokaż w powiadomieniach nowe wpisy na tablicy oraz prywatne wiadomości i połączenia";
...
App::$strings["Poke somebody in your addressbook"] = "Szturchnij kogoś w swojej książce adresowej";
...
App::$strings["[\$Projectname:Notify] %s posted to your profile wall"] = "[\$Projectname:Notify]%s opublikowany na Twojej tablicy profilu";
App::$strings["%1\$s posted to your profile wall at %2\$s"] = "%1\$s opublikowano na tablicy Twojego profilu pod adresem %2\$s";
App::$strings["%1\$s posted to [zrl=%2\$s]your wall[/zrl]"] = "%1\$s opublikował na [zrl=%2\$s]Twojej tablicy[/zrl]";
...
App::$strings["You've received an new connection request from '%1\$s' at %2\$s"] = "Otrzymał(eś/aś) nowe żądanie połączenia od „%1\$s” na %2\$s";
App::$strings["You've received [zrl=%1\$s]a new connection request[/zrl] from %2\$s."] = "Otrzymał(eś/aś) [zrl=%1\$s]nowe żądanie połączenia [/zrl] od %2\$s.";
...
App::$strings["You've received a friend suggestion from '%1\$s' at %2\$s"] = "Otrzymał(eś/aś) propozycję znajomości od „%1\$s” na %2\$s";
App::$strings["You've received [zrl=%1\$s]a friend suggestion[/zrl] for %2\$s from %3\$s."] = "Otrzymał(eś/aś) [zrl=%1\$s] propozycję znajomości[/ zrl] dla %2\$s od %3\$s.";
App::$strings["Name:"] = "Nazwa:";
...
App::$strings["verified"] = "sprawdzono";
...
App::$strings["likes %1\$s's %2\$s"] = "polubił %2\$s %1\$s";
App::$strings["doesn't like %1\$s's %2\$s"] = "nie polubił %1\$s %2\$s";
...
App::$strings["The provided email domain is not among those allowed on this site"] = "Podana domena e-mail nie należy do domen dozwolonych w tym serwisie";
...
App::$strings["Send email to all hub members."] = "Wyślij wiadomość e-mail do wszystkich członków serwisu.";
App::$strings["Message subject"] = "Temat wiadomości";
App::$strings["Sender Email address"] = "Adres e-mail nadawcy";
App::$strings["Test mode (only send to hub administrator)"] = "Tryb testowy (wysyłaj tylko do administratora serwisu)";
...
App::$strings["This will import all your cloud files from another server."] = "Spowoduje to zaimportowanie wszystkich plików w chmurze z innego serwisu Hubzilla.";
...
App::$strings["%1\$s dislikes %2\$s's %3\$s"] = "%1\$s niepolubień %2\$s %3\$s";
...
App::$strings["Hub default profile photo"] = "Domyślne zdjęcie profilowe serwisu";
...
App::$strings["Choose a project, developer, or public hub to support with a one-time donation"] = "Wybierz projekt, dewelopera lub publiczny serwis, aby wesprzeć jednorazową darowizną";
...
App::$strings["Allow magic authentication only to websites of your immediate connections"] = "Zezwalaj na magiczne uwierzytelnianie tylko w serwisach internetowych Twoich bezpośrednich połączeń";
