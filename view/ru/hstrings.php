...
App::$strings["Email address already in use"] = "Адрес электронной почты уже используется";
...
App::$strings["Valid from"] = "Действительно с";
App::$strings["and expire"] = "и истекает";
App::$strings["New register request"] = "Новый запрос на регистрацию";
App::$strings["Your validation token is"] = "Ваш проверочный код";
App::$strings["Hold on, you can continue verification in"] = "Немного подождите. Вы можете продолжить проверку через ";
App::$strings["and"] = "и";
...
App::$strings["This site requires verification. After completing this form, please check the notice or your email for further instructions."] = "Этот сайт требует проверки. После заполнения формы, пожалуйста, проверьте уведомление или свою электронную почту для получения дальнейших инструкций.";
App::$strings["This site has exceeded the number of allowed daily account registrations"] = "На этом сайте превышено допустимое количество ежедневных регистраций.";
...
App::$strings["Not verified"] = "Не подтверждён";
...
App::$strings["Verification status"] = "Статус проверки";
App::$strings["Timeframe"] = "Временные рамки";
App::$strings["specified,atip"] = "указано, atip";
...
App::$strings["Account registration delay"] = "Задержка при регистрации учётных записей";
App::$strings["How long a registration request has to wait before validation can perform. No delay if zero or no value."] = "Задержка запроса на регистрацию, прежде чем сможет выполняться проверка. Без задержки, если значение равно нулю.";
App::$strings["duration up from now"] = "продолжительность с настоящего момента";
App::$strings["Account registration expiration"] = "Истечение срока регистрации учётной записи";
App::$strings["How long a registration to confirm remains valid. Not expire if zero or no value."] = "Как долго подтверждение запроса на регистрацию учётой записи будет действительно. Без ограничений при нулевом или не указанном значении.";
...
App::$strings["If you operate with register duties (see ZAR0830C), best practise is to tell cleartext about here"] = "Если вы работаете с регистрационными дежурствами (см. ZAR0830C), рекомендуется указывать это здесь открытым текстом";
App::$strings["Does this site allow new member registration?"] = "Разрешается ли регистрация новых пользователей на этом сайте?";
App::$strings["Registration is also possible without having to enter an email address."] = "Регистрация также возможна без указания адреса электронной почты.";
App::$strings["Registration is also supported without requiring an email address from the applicant. Instead of the email address an artificial identification is generated, which has to be confirmed in a separate dialog. The default value is (Off) and corresponds to the registration procedure up to version 5.4.x."] = "Регистрация также поддерживается без запроса адреса электронной почты от заявителя. Вместо адреса электронной почты генерируется идентификационный код, который необходимо подтвердить в отдельном диалоге. Значение по умолчанию \"выкл.\" и соответствует процедуре регистрации до версии 5.4.x.";
App::$strings["Registration office on duty"] = "Процедура регистрации в дежурном режиме";
App::$strings["The weekdays and hours the register office is open for registrations"] = "Oткрыт для регистрации в будние дни и часы.";
App::$strings["Split weekdays and hours per `:`"] = "Разбейте будние дни и часы с помощью `:`";
App::$strings["Separate weekday(s):hour(s) pairs with blank(s)"] = "Отделите пары дни_недели:часы при помощи пробелов";
App::$strings["Several values or ranges are to split by comma"] = "Несколько значений или диапазонов разделяются запятыми.";
App::$strings["From-To ranges are joined with `-`"] = "Диапазоны он и до объединяются `-`";
App::$strings["ie"] = "т.е.";
App::$strings["or"] = "или";
App::$strings["Parse and test your input"] = "Разберите и проверьте свой ввод ";
App::$strings["If left empty, defaults to 24h closed everyday the week."] = "Если оставить пустым, по умолчанию будет закрыто 24 часа каждого дня.";
App::$strings["To open 24h everyday the week, short is `-:-`."] = "Для открытия 24 часа каждый день используйте `-:-`";
App::$strings["Note, ranges are specified as open-close pairs and in case of"] = "Обратите внимание, диапазоны указаны как пары открытия - закрытия. Например, в случае";
App::$strings["results to: opens 9h and closes 12h. If meant open 9h to 12h exactly, say `0900-1201`"] = "это означает \"открывается в 9 часов и закрывается в 12 часов\".";
App::$strings["Account registrations max per day"] = "Максимальное число регистрируемых учётных записей в день";
App::$strings["How many registration requests the site accepts during one day. Unlimited if zero or no value. Default 50"] = "Сколько запросов на регистрацию сайт принимает за один день. Без ограничений, если значение равно нулю (по умолчанию 50).";
App::$strings["Account registrations from same ip"] = "Регистрация учётных записей с одного IP-адреса";
App::$strings["How many pending registration requests the site accepts from a same ip address."] = "Сколько ожидающих запросов на регистрацию сайт принимает с одного и того же IP-адреса.";
App::$strings["Auto channel create"] = "Автоматическое создание канала";
App::$strings["Auto create a channel when register a new account. When On, the register form will show additional fields for the channel-name and the nickname."] = "Автоматическое создание канала при регистрации новой учетной записи. Если включено, в форме регистрации будут отображаться дополнительные поля для имени канала и псевдонима.";
...
App::$strings["Invitation also"] = "Также приглашение";
App::$strings["Also allow new member registrations with an invitation code. Above register policy must be set to Yes."] = "Также разрешить регистрацию новых участников по коду приглашения. Вышеуказанная политика регистрации должна быть установлена в \"Да\". ";
...
App::$strings["Email resent"] = "Электронное письмо повторно отправлено";
App::$strings["Resent failed"] = "Повторная отправка не удалась";
App::$strings["Verify successfull"] = "Проверка прошла успешно";
App::$strings["Last step will be by an instance admin to agree your account request"] = "Последним шагом будет подтверждение вашего запроса на регистрацию учётной записи администратором хаба";
...
App::$strings["Channel still not created"] = "Канал всё ещё не создан";
...
App::$strings["Your Registration"] = "Ваша регистрация";
App::$strings["Register Verification"] = "Проверка регистрации";
App::$strings["Resend"] = "Отправить повторно";
App::$strings["Register Verification Status"] = "Статус проверки регистрации";
App::$strings["Verification successful!"] = "Проверка прошла успешно! ";
App::$strings["After your account has been approved by our administrator you will be able to login with your ID"] = "После того, как ваша учетная запись будет одобрена администратором, вы сможете войти со своим идентификатором";
App::$strings["and your provided password."] = "и паролем";
App::$strings["Sorry for any inconvenience. Thank you for your response."] = "Приносим извинения за неудобства. Благодарим за ваш ответ.";
App::$strings["Registration request denied"] = "Запрос на регистрацию отклонён";
App::$strings["Please enter your validation token"] = "Пожалуйста введите ваш проверочный код";
...
App::$strings["open"] = "открыто";
App::$strings["closed"] = "закрыто";
App::$strings["Registration is currently"] = "Регистрация в настоящее время";
App::$strings["Next opens"] = "Следующая откроется";
